...
//    private static NormalMissile missile;
     ...
     */
    public GameScreen(Game game, Trooper trooper)
    {
        super(game);
        setWindowDimensions();
...
//        missile = null;
    ...
    public void paint(float dTime)
    {
        ...
        //draw game objects
        g.drawImage(Assets.trooper, FallingGame.trooper.getCenterX(), FallingGame.trooper.getCenterY());
